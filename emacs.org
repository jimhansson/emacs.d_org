...
*** Global Keys for OrgMode																			:keybindings:
      ...
      (global-set-key (kbd "S-<f6>") 'org-agenda-list)
...
*** Init
      ...
      (dolist (directory my-org-directories) 
        ...
        (setq local-org-directory directory)
		...
		#+end_src
***** TODO instead of using setq for vars use let expression
