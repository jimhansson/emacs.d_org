...
* Google Integration
  ...
  this needs oauth2 from elpa
** Google maps                                                          :org:
   #+begin_src emacs-lisp
     (add-to-list 'load-path (concat local-emacs-org-dir "google-maps"))
     (require 'google-maps)
...
** Google Weather                                                       :org:
   ...
   #+begin_src emacs-lisp
     ...
     (setq org-google-weather-icon-directory (concat local-emacs-org-dir "google-weather-icons"))
...
*** We want weather first on every day
